...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(menosProductoresT1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 330, -1, -1));

        masProductoresT1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        masProductoresT1.setText("+");
        masProductoresT1.setAlignmentX(0.5F);
        jPanel1.add(masProductoresT1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 330, -1, -1));
    ...
    * Boton para finalizar el programa
    ...
    private void menosProductoresBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menosProductoresBActionPerformed
        ...
        if (numero > 0) {
            ...
            //Casos posibles para productor de botones
            switch (numero) {
                case 0:
...
//        String namePro = app.getProductoresB().get(app.getProductoresB().size).getNombre();
        ...
        if (numero < 3) {
            ...
            //Casos posibles para productor botones
            switch (numero) {
                case 1:
    ...
    private javax.swing.JLabel numCB;
    private javax.swing.JLabel numCJoy;
    private javax.swing.JLabel numCPantN;
    private javax.swing.JLabel numCPantT;
    private javax.swing.JLabel numCSD;
