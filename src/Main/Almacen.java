...
public class Almacen extends Thread {
    ...
    public volatile int almacenBotones = 0;
    public volatile int almacenPantallas = 0;
    public volatile int almacenJoystick = 0;
    public volatile int almacenSD = 0;
    ...
    public int getAlmacenBotones() {
        return almacenBotones;
    }

    
    
    public void setAlmacenBotones(int almacenBotones) {
