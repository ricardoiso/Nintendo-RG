...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        diasRestantes.setText("10");
        jPanel1.add(diasRestantes, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 400, -1, -1));
    ...
    * Boton para finalizar el programa
    ...
    private void menosProductoresBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menosProductoresBActionPerformed
        ...
        if (numero > 0) {
            ...
            if (numero == 0) {
                ;
                System.out.println(app.getProductoresB().get(0).getActive());
                app.getProductoresB().get(0).setActive(false);
                System.out.println(app.getProductoresB().get(0).getid());
            }
            if (numero == 1) {
                System.out.println(app.getProductoresB().get(1).getActive());
                app.getProductoresB().get(1).setActive(false);
                System.out.println(app.getProductoresB().get(1).getid());
            }
            if (numero == 2) {
                System.out.println(app.getProductoresB().get(2).getActive());
                app.getProductoresB().get(2).setActive(false);
                System.out.println(app.getProductoresB().get(2).getid());
            }
        }
...
//        String namePro = app.getProductoresB().get(app.getProductoresB().size).getNombre();
        ...
        if (numero < 3) {
            ...
            if (numero == 2) {
                ...
                System.out.println("Hola, soy dos activado");
            }
            if (numero == 3) {
                app.getProductoresB().get(2).setActive(true);
                System.out.println("Hola, soy tres activado");
            }
        }
